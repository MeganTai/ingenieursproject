...
class Kamers:
    ...
    def bureau(self):
        ...
        self.pot_4 = Items(145,495,36,36, afbeeldingen_folder / "pot.PNG")
        self.pot_5 = Items(290,303,36,36, afbeeldingen_folder / "pot.PNG")
        self.pot_6 = Items(290,399,36,36, afbeeldingen_folder / "pot.PNG")
        self.pot_7 = Items(386,495,36,36, afbeeldingen_folder / "pot.PNG")
        ...
        self.bureau_sprites.add(self.pot_1, self.pot_2, self.pot_3, self.pot_4, self.pot_5, self.pot_6, self.pot_7, self.pc, self.boek, self.portret, self.hamer, self.vuilbak, self.kast)
